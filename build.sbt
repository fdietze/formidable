...
lazy val formidable = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      (if (isScala3.value) Seq("com.softwaremill.magnolia1_3" %%% "magnolia" % "1.3.15")
       else
         Seq("com.softwaremill.magnolia1_2" %%% "magnolia" % "1.1.10", "org.scala-lang" % "scala-reflect" % "2.13.16")),
